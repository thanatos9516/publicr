<!-- Navigation -->
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0; background-color: #306A25;">
            <div class="navbar-header">
               <a class="navbar-brand" href="">FCHMAINTENANCE</a>
            </div>
			
			<ul class=" nav navbar-nav">
				<li id="cartme" style="cursor:pointer">
                   <a id="cart_control"><i class="fa fa-shopping-cart fa-fw"></i>My Shopping Cart</a>
                </li>
